        ...
        items: fields.array(
          fields.object({
            ...
            dataType: fields.select({
              label: 'Tipo dato',
              description: 'JSON: legge i valori da un\'API. HTML: legge i valori da una pagina HTML statica (rete Prealpino). Foto: nessun valore, solo webcam. Iframe: player embedded di terzi (es. Windy).',
              options: [
